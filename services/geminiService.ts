...
export const generateDailyBriefing = async (
  ...
  const prompt = `
    ...
    Se a fila estiver vazia, sugira uma action rápida de marketing para atrair clientes agora.
  `;

  try {
    // Corrected: use 'gemini-3-flash-preview' for basic text tasks (summarization/briefing).
